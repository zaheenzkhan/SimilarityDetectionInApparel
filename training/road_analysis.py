...
runs_dir = './runs'
training_dir ='./sample_data/data_road/training'
vgg_path = './sample_data/vgg'
...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    fcn8 = tf.layers.conv2d(layer7, filters=num_classes,
                            kernel_size=1, name="fcn8")
...
def optimize(nn_last_layer, correct_label, learning_rate, num_classes):
    ...
    train_op = tf.train.AdamOptimizer(
        learning_rate=learning_rate).minimize(loss_op, name="fcn_train_op")
...
#        print(layer4.get_shape().as_list())
        ...
        helper.save_inference_samples(
            runs_dir, data_dir, session, image_shape, logits, keep_prob, image_input)
